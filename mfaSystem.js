...
// Include on checkout pages. Initialize with CheckoutMFA.init({apiBaseUrl, merchantId, formSelector, hiddenFieldName, enforceMode, headers, resendCooldownMs, challengeTTLSeconds})
...
(function() {
    const DEFAULTS = {
        ...
        hiddenFieldName: 'mfa_token',       // Name of the hidden field to add to the form after successful MFA
    ...
    (function autoInit() {
        try {
            ...
            const cfg = {
                ...
                hiddenFieldName: ds.hiddenFieldName || 'mfa_token',
